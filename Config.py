...
max_events = 1000
energy=0.1 # GeV, certified
particle_id='e-'
incidentAngleDegrees=0
runNumber=1

simulation_name=particle_id+str(energy)+"GeV"+str(int(max_events/1000))+"k"
# simulation_name=particle_id+str(energy)+"GeV"+str(incidentAngleDegrees)+"deg"
# simulation_name="muon"
...
hcal_edge_offset = -450
position=[-xVector*beamDistance, 0., -zVector*beamDistance+hcal_edge_offset] # mm
...
# print("the run number is:",simulation.runNumber)

# process.sequence = [ simulation, digi.HcalDigiProducer(), digi.HcalRecProducer(), hcal.HcalVetoProcessor()]
